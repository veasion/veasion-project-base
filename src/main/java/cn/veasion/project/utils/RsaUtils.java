...
public class RsaUtils {
     ...
     * @return 不一致返回 null
     */
    public static String decryptByPrivateKey(String privateKeyText, String text1, String text2) throws Exception {
        String s1 = decryptByPrivateKey(privateKeyText, text1);
        String s2 = decryptByPrivateKey(privateKeyText, text2);
